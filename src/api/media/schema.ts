...
export const Media = Type.Object({
  ...
  file: Type.Required(Type.String({ description: "A path (URL or local) to the audio file"})),
  ...
  position: Type.Integer({ minimum: 0, description: "Position of media in its program" }),
